export const CacheKey = {
  ...
  USER_SPACES: (userId: string, workspaceId: string) =>
    `entity:user-spaces:${userId}:${workspaceId}`,
...
export const USER_SPACES_CACHE_TTL_MS = 120_000; // 2 min — invalidated on membership/role writes
